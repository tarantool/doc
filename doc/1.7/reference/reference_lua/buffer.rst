...
for use as an option for methods of the :ref:`net_box module <net_box-module>`.
Ordinarily the net_box methods return a Lua table.
If a buffer option is used, then the net_box methods return a
raw MsgPack string.
