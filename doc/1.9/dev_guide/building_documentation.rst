...
1. Use ``git`` to download the latest source code of this documentation from the
   GitHub repository ``tarantool/doc``, branch 1.9. For example, to download to a local
...
5. Open your browser and enter ``127.0.0.1:8000/doc/1.9`` into the address box. If
