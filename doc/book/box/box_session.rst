...
.. container:: table
    ...
    +--------------------------------------+---------------------------------+
    | :ref:`box.session.on_access_denied() | Define a trigger reporting about|
    | <box_session-on_access_denied>`      | actions when access is denied   |
    +--------------------------------------+---------------------------------+
...
.. function:: box.session.on_access_denied([trigger-function [, old-trigger-function]])
    ...
    **Example**
    ...
    For example, server administrator can log denied user's actions like this:
