...
.. NOTE::
    По некоторым причинам вам может понадобиться :ref:`базовое руководство для Tarantool <app_server-launching_app>`.
...
`этот
раздел <https://www.tarantool.io/ru/doc/latest/book/app_server/launching_app/>`__.
