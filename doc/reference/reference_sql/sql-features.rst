...
..  container:: table
    ...
    ..  list-table::
        ...
        *   -   E011-03
            ...
            -   No, NUMERIC data types are not supported,
                although the DECIMAL data type is supported.
        *   -   E011-04
            -   Arithmetic operators
            -   ``SELECT 10+1, 9-2, 8*3, 7/2 FROM t;``
            -   :ref:`OK <sql_operator_arithmetic>`.
        *   -   E011-05
            -   Numeric comparisons
            -   ``SELECT * FROM t WHERE 1 < 2;``
            -   :ref:`OK <sql_operator_comparison>`.
        *   -   E011-06
...
..  container:: table
    ...
    ..  list-table::
        ...
        *   -   E021-02
            ...
            -   No, Tarantool only allows VARCHAR(n), which is a
        ...
        *   -   E021-04
            ...
            -   OK. Tarantool treats this as a synonym of
        ...
        *   -   E021-06
            ...
            -   No. There is no such function. There is a function
                :ref:`SUBSTR(x,n,n) <sql_function_substr>`, which is OK.
        *   -   E021-07
            -   Character concatenation
            -   ``SELECT 'a' || 'b' FROM t;``
            -   :ref:`OK <sql_operator_concatenate>`.
        *   -   E021-08
            -   UPPER and LOWER functions
            -   ``SELECT upper('a'),lower('B') FROM t;``
            -   OK. Tarantool supports both
                :ref:`UPPER() <sql_function_upper>` and
                :ref:`LOWER() <sql_function_lower>`.
        *   -   E021-09
            -   TRIM function
            -   ``SELECT trim('a ') FROM t;``
            -   :ref:`OK <sql_function_trim>`.
        *   -   E021-10
        ...
        *   -   E021-11
            ...
            -   No. Tarantool's :ref:`POSITION <sql_function_position>` function
                requires '``,``' rather than '``IN``'.
        *   -   E021-12
            -   Character comparison
            -   ``SELECT * FROM t WHERE s1 > 'a';``
            -   OK. We should note here that comparisons use a binary
...
..  container:: table
    ...
    ..  list-table::
        ...
        *   -   E051-06
            ...
            -   OK. Tarantool supports :ref:`HAVING <sql_having>`, and GROUP BY is not
...
..  container:: table
    ...
    ..  list-table::
        ...
        *   -   E141-01
            ...
            -   :ref:`OK <sql_table_constraint_def>`.
        *   -   E141-02
        ...
        *   -   E141-03
            ...
            -   OK, although Tarantool shouldn't always insist on
...
..  container:: table
    ...
    ..  list-table::
        ...
        *   -   E182
            ...
            -
            -   OK. Any of the Tarantool connectors should be able
...
..  container:: table
    ...
    ..  list-table::
        ...
        *   -   F021
            ...
            -   No. Tarantool's metadata is not in a schema with that
...
..  container:: table
    ...
    ..  list-table::
        ...
        *   -   F031-04
            ...
            -   OK. Tarantool supports :ref:`ALTER TABLE <sql_alter_table>`,
                and support for ADD COLUMN was added in Tarantool 2.7.
        *   -   F031-13
            -   DROP TABLE statement: RESTRICT clause
            -   ``DROP TABLE t20 RESTRICT;``
            -   No. Tarantool supports :ref:`DROP TABLE <sql_drop_table>` but not this clause.
        *   -   F031-16
            -   DROP VIEW statement: RESTRICT clause
            -   ``DROP VIEW v2 RESTRICT;``
            -   No. Tarantool supports :ref:`DROP VIEW <sql_drop_view>` but not this clause.
        *   -   F031-19
            -   REVOKE statement: RESTRICT clause
            -
            -   No. Tarantool does not support privileges except via NoSQL.
...
..  container:: table
    ...
    ..  list-table::
        ...
        *   -   F261-03
            ...
            -   :ref:`OK <sql_function_nullif>`
        *   -   F261-04
            -   COALESCE
            -   ``SELECT coalesce(s1,7) FROM t;``
            -   :ref:`OK <sql_function_coalesce>`.
...
..  container:: table
    ...
    ..  list-table::
        ...
        *   -   F311-05
            -   GRANT statement
            -   No. Tarantool doesn't have GRANT inside CREATE SCHEMA.
...
..  container:: table
    ...
    ..  list-table::
        ...
        *   -   F812
            -   Basic flagging
            -
            -   No. Tarantool doesn't support any flagging.
...
..  container:: table
    ...
    ..  list-table::
        ...
        *   -   T321-01
            ...
            -   No. User-defined functions for SQL are created in
