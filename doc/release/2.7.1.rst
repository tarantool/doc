...
Announcement: https://github.com/tarantool/tarantool/releases/tag/2.7.1
...
2.7.1 is the
`beta <https://www.tarantool.io/en/doc/latest/dev_guide/release_management/#release-policy>`_
