...
* Оптимизирована пагинация в ``crud.select()`` и ``crud.pairs()`` с курсором ``after``: для позиционирования курсора за O(1) на Tarantool 2.10+ используется нативная опция ``after``.
