...
-   :ref:`Local role-based access model <cm_access_control_rbac>` allow flexible
...
-   :ref:`API tokens <tcm_api_tokens>` enable intergration with third-party applications.
-   :ref:`Sessions management <tcm_sessions>` allow administrators to view and
