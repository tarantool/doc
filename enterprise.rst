      ...
      <div class="row">
        <div class="col-xs-12 col-md-6 col-md-offset-1">
          <form class="hidden-sm hidden-md hidden-lg">
            ...
            <input class="hidden" type="radio" name="Enterprise" value="true" checked="">
...
.. raw:: html
              ...
              <p class="header-p text-center">Accelerate and Federate Any Data Source
                <br>
                <!--<span class="integrate-see-how enterprise">See How!</span>-->
              </p>
            </section>
          </div>
        </div>
  ...
  <!-- Google Code for Form Submit - Free Trial - Enterprise Conversion Page
  ...
  <script type="text/javascript">
    ...
    goog_snippet_vars = function () {
      ...
      w.google_conversion_label = "SjusCO7c628Qqfr7mQM";
  ...
  <!-- Google Code for Free Trial Enterprise  - New Campaign Conversion Page -->
  <script type="text/javascript">
    /* <![CDATA[ */
