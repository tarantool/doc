  ...
  <div id="page-try-it">
    <div class="container-fluid">
        ...
        <div class="col-xs-12 col-md-12">
          <table class="table-bordered col-xs-12 col-md-12" id="comparison-chart">
            ...
            <tbody>
                    ...
                    <tbody>
                      <tr>
                        <td class="col-xs-3 col-md-3 text-center">
                          <img src="_static/images/tarantool-io/check.png"> </td>
                        <td class="col-xs-3 col-md-3 text-center">
                          <img src="_static/images/tarantool-io/check.png"> </td>
                        <td class="col-xs-3 col-md-3 text-center">
                          <img src="_static/images/tarantool-io/check.png"> </td>
              ...
              <tr>
                ...
                <td class="col-xs-7 col-md-7">
                  <table class="col-xs-12 col-md-12 subtable">
                    <tbody>
                      <tr>
                        <td class="col-xs-3 col-md-3 text-center"> </td>
                        <td class="col-xs-3 col-md-3 text-center">
                          <img src="_static/images/tarantool-io/check.png"> </td>
                        <td class="col-xs-3 col-md-3 text-center">
                          <img src="_static/images/tarantool-io/check.png"> </td>
              ...
              <tr>
                <td class="col-xs-5 col-md-5" style="color:#475560">
                  <b>Try Tarantool</b>
                </td>
                <td class="col-xs-7 col-md-7">
                  <table class="col-xs-12 col-md-12 subtable">
                    <tbody>
                      <tr>
                        <td class="col-xs-3 col-md-3 text-center" style="padding:10px; z-index: -1;">
                          <a type="button" class="btn" href="./downloads/downloads.html" style="width:100%; height:100%; background-color:#fd5e3f; color:#fff">
                            <span>Download</span>
                            <span>Down
                              <br>Load</span>
                          </a>
                        ...
                        <td class="col-xs-3 col-md-3 text-center" style="padding:10px; z-index: -1;">
                          <a type="button" class="btn" href="./live-demo.html" style="width:100%; height:100%; background-color:#0272c2; color:#fff">
                            <span>Live Demo</span>
                            <span>Live
                              <br>Demo</span>
                          </a>
                        ...
                        <td class="col-xs-3 col-md-3 text-center" style="padding:10px; z-index: -1;">
                          <a type="button" class="btn" href="./live-demo.html" style="width:100%; height:100%; background-color:#00a000; color:#fff">
                            <span>Live Demo</span>
                            <span>Live
                              <br>Demo</span>
                          </a>
                        ...
                        <td class="col-xs-3 col-md-3 text-center" style="padding:10px; z-index: -1;">
                          <a type="button" class="btn" href="./live-demo.html" style="width:100%; height:100%; background-color:#ff6600; color:#fff">
                            <span>Live Demo</span>
                            <span>Live
                              <br>Demo</span>
                          </a>
              ...
              <div class="request-btn-row row">
                <div class="container-fluid">
                  <div class="col-xs-10 col-xs-offset-1">
                    <a href="./unwired.html">
                      <button type="button" class="circle-btn unwired">Request Free Trial</button>
                    </a>
                  </div>
                  <div class="col-xs-12">
                ...
                <div class="container-fluid">
                  <div class="col-xs-10 col-xs-offset-1">
                    <a href="./enterprise.html">
                      <button type="button" class="circle-btn enterprise">Request Free Trial</button>
                    </a>
                  </div>
                  <div class="col-xs-12">
                    <p> Need a hand? Our engineers are standing by to optimize your trial</p>
      ...
      <div id="try-it-footer">
        <h3>How can you transform your business?
          <br>
          <a href="./live-demo.html">Schedule a live demo.</a>
        </h3>
      </div>
    </div>
  </div>
