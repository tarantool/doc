...
class DisqusNode(nodes.General, nodes.Element):
    ...
    def __init__(self, disqus_shortname, disqus_identifier, disqus_language):
        ...
        self.disqus_language = disqus_language
...
#            'data-disqus-language'  : node.disqus_language
        }
...
class DisqusDirective(Directive):
    ...
    def run(self):
        ...
        disqus_language = self.state.document.settings.env.config.language
        return [DisqusNode(disqus_shortname, disqus_identifier, disqus_language)]
