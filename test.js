$(function() {
  ...
  // var page = $('<object type="text/html" data="http://localhost:8000/en/download/os-installation/1.7/ubuntu.html"></object>');
  container.prepend('<object id="obj" type="text/html" data="http://localhost:8000/en/download/os-installation/1.7/ubuntu.html" width="800px" height="600px" style="overflow:auto;border:5px ridge blue"></object>');

  // console.log('tttt', container.html());
  // console.log('tttt', $(container.find('#obj'))[0].html());

  $.ajax({
    url: "http://localhost:8000/en/download/os-installation/1.7/ubuntu.html",
    type:'GET',
    success: function(data) {
       $(data).find('.b-section-title').html();
    }
  });

  // var page_title = page.find('.b-section-title').text();
  // var page_text = page.find('.b-os-installation-content').text();
  //
  // console.log(page_title, page_text);
  //
  // title.prepend(page_title);
  // text.prepend(page_text);
  ...
  //     add('http://localhost:8000/en/download/os-installation/1.7/' + os_installation_page_names[keys[i]] + '.html');
  //     return;
  //   }
  // }
  //
  ...
  //     add('http://localhost:8000/en/download/os-installation/1.7/' + os_installation_page_names['docker'] + '.html');
  //     return;
  //   }
  // }

  function add(link) {
    container.html('<object type="text/html" data=' + link + ' width="800px" height="600px" style="overflow:auto;border:5px ridge blue"></object>');
  }
});
